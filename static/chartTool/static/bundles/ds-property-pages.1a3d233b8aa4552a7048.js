webpackJsonp([5], {
  14: function (e, t, o) {
    ...
    function i(e) {
      function t(t, o, i) {
        e.call(this, t, o, i), this._linetool = i, this._templateList = new s(this._linetool._constructor, this.applyTemplate.bind(this))
      }

      return inherit(t, e), t.prototype.applyTemplate = function (e) {
        this._linetool.restoreTemplate(e), this._model.model().updateSource(this._linetool), this.loadData()
    ...
    var a = o(10), r = a.PropertyPage, l = a.ColorBinding, p = o(47).addColorPicker, s = o(268);
    inherit(n, r), n.prototype.createOneColorForAllLinesWidget = function () {
      var e = $("<td class='colorpicker-cell'>");
      return this.bindControl(new l(p(e), this._linetool.properties().collectibleColors, !0, this.model(), "Change All Lines Color", 0)), {
        label: $("<td>" + $.t("Use one color") + "</td>"),
        editor: e
      }
    }, n.prototype.addOneColorPropertyWidget = function (e) {
      var t = this.createOneColorForAllLinesWidget(), o = $("<tr>");
      o.append($("<td>")).append(t.label).append(t.editor), o.appendTo(e)
    }, n = i(n), n.createTemplatesPropertyPage = i, e.exports = n
  }, 15: function (e, t, o) {
    "use strict";
    function i() {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), o(22), o(285), t.createLineWidthEditor = i
  }, 31: function (e, t, o) {
    "use strict";
    function i() {
      ...
      }, {html: '<div class="linestyle dashedline"/>', value: a.LINESTYLE_DASHED}])
    }

    var n, a;
    Object.defineProperty(t, "__esModule", {value: !0}), n = o(738), a = o(115), t.createLineStyleEditor = i
  }, 65: function (e, t, o) {
    "use strict";
    function i(e) {
      var t = $('<div class="transparency-slider"><div class="gradient"></div></div>').slider({
        ...
        o = ["-moz-linear-gradient(left, %COLOR 0%, transparent 100%)", "-webkit-gradient(linear, left top, right top, color-stop(0%,%COLOR), color-stop(100%,transparent))", "-webkit-linear-gradient(left, %COLOR 0%,transparent 100%)", "-o-linear-gradient(left, %COLOR 0%,transparent 100%)", "linear-gradient(to right, %COLOR 0%,transparent 100%)"];
      return t.updateColor = function (e) {
        var i = t.find(".gradient");
        o.forEach(function (t) {
          i.css("background-image", t.replace(/%COLOR/, e))
        })
      }, e ? (t.updateColor(e.val() || "black"), e.on("change", function (e) {
        t.updateColor(e.target.value)
      })) : t.updateColor("black"), t
    }

    Object.defineProperty(t, "__esModule", {value: !0}), o(22), o(285), t.createTransparencyEditor = i
  }, 81: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
    ...
    var n = o(10), a = n.PropertyPage, r = n.GreateTransformer, l = n.LessTransformer, p = n.ToIntTransformer,
      s = n.SimpleStringBinder;
    o(142), inherit(i, a), i.BarIndexPastLimit = -5e4, i.BarIndexFutureLimit = 15e3, i.prototype.bindBarIndex = function (e, t, o, n) {
      ...
      i.prototype.createPriceEditor = function (e) {
        var t, o = this._linetool.ownerSource().formatter(), i = function (e) {
          return o.format(e)
        }, n = function (e) {
          var t = o.parse(e);
          if (t.res)return t.price ? t.price : t.value
        }, a = $("<input type='text'>");
        return a.TVTicker({step: o._minMove / o._priceScale || 1, formatter: i, parser: n}), e && (t = [function (t) {
          var o = n(t);
          return void 0 === o ? e.value() : o
        }], this.bindControl(new s(a, e, t, !1, this.model(), "Change " + this._linetool + " point price")).addFormatter(function (e) {
          return o.format(e)
        })), a
      }, i.prototype._createPointRow = function (e, t, o) {
      var i, n, a, r, l, p = $("<tr>"), s = $("<td>");
      return s.html($.t("Price") + o), s.appendTo(p), i = $("<td>"), i.appendTo(p), n = this.createPriceEditor(t.price), n.appendTo(i), a = $("<td>"), a.html($.t("Bar #")), a.appendTo(p), r = $("<td>"), r.appendTo(p), l = $("<input type='text'>"), l.appendTo(r), l.addClass("ticker"), this.bindBarIndex(t.bar, l, this.model(), "Change " + this._linetool + " point bar index"), p
    }, i.prototype.prepareLayoutForTable = function (e) {
      var t, o, i, n, a, r = this._linetool.points(), l = r.length;
      for (t = 0; t < r.length; t++)o = r[t], (i = this._linetool.properties().points[t]) && (n = t || l > 1 ? " " + (t + 1) : "", a = this._createPointRow(o, i, n), a.appendTo(e))
    }, i.prototype.prepareLayout = function () {
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.prepareLayoutForTable(this._table), this.loadData()
    ...
    }(t.TabPriority || (t.TabPriority = {})), function (e) {
    ...
    }(t.TabNames || (t.TabNames = {})), function (e) {
    ...
    var a = o(10), r = a.PropertyPage, l = a.GreateTransformer, p = a.LessTransformer, s = a.ToIntTransformer,
      d = a.ToFloatTransformer, h = a.SimpleComboBinder, c = a.BooleanBinder, b = a.DisabledBinder, u = a.ColorBinding,
      C = a.SliderBinder, y = a.SimpleStringBinder, g = o(47).addColorPicker, w = o(31).createLineStyleEditor,
      T = o(1122).createShapeLocationEditor, _ = o(1123).createShapeStyleEditor, m = o(15).createLineWidthEditor,
      f = o(1124).createVisibilityEditor, L = o(1120).createHHistDirectionEditor, v = o(476).createPlotEditor,
      k = o(38).NumericFormatter, S = o(45), P = o(106).PlotType, x = o(13).getLogger("Chart.Study.PropertyPage");
    inherit(i, r), i.prototype.prepareLayout = function () {
      function e(e) {
        return (new k).format(e)
      }

      var t, o, n, a, r, l, p, s, b, T, _, f, L, v, P, B, E, R, F, I, A, D, W, O, V, j, z, M, H, q, N, G, U, Y, K, Q;
      for (this._table = $("<table/>"), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), t = this._study.metaInfo(), o = {}, n = 0; n < t.plots.length; ++n)if (!(this._study.isSelfColorerPlot(n) || this._study.isTextColorerPlot(n) || this._study.isDataOffsetPlot(n) || this._study.isOHLCColorerPlot(n))) {
        if (l = t.plots[n], t.styles) {
          if (t.styles[l.id]) a = t.styles[l.id].isHidden; else if (!this._study.isOHLCSeriesPlot(n))continue;
      ...
      var r, l, p, s, d, b, y, w, T, _, f, L, k, S, P, x = e, B = t.id, E = null, R = B.startsWith("fill");
      E = a ? this._study.properties().ohlcPlots[B] : R ? this._study.properties().filledAreasStyle[B] : this._study.properties().styles[B], r = 0;
      for (l in o.colors)p = i.colors[l], s = $('<tr class="line"/>'), s.appendTo(this._table), $("<td/>").appendTo(s), d = $("<td/>"), d.appendTo(s), d.addClass("propertypage-name-label"), d.html($.t(p.name.value(), {context: "input"})), b = $("<td/>"), b.appendTo(s), b.addClass("colorpicker-cell"), y = g(b), this.bindControl(new u(y, p.color, !0, this.model(), n, E.transparency)), !R && this._study.isLinePlot(x) && (w = $("<td/>"), w.appendTo(s), T = m(), T.appendTo(w), this.bindControl(new C(T, p.width, !0, this.model(), n, this._study.metaInfo().isTVScript)), _ = $("<td>"), _.appendTo(s), 0 === r && (f = v(), f.appendTo(_), this.bindControl(new h(f, E.plottype, parseInt, !0, this.model(), n)), L = $("<input type='checkbox'>"), k = $('<td colspan="4">').css({whiteSpace: "nowrap"}), S = $("<span>").html($.t("Price Line")), P = $("<span>"), P.append(L), k.append(P).append(S).appendTo(s), this.bindControl(new c(L, E.trackPrice, !0, this.model(), "Change Price Line")))), r++
    }, i.prototype._prepareLayoutForArrowsPlot = function (e, t) {
      var o, i, n, a, r, l, p, s = t.id, d = this._study.properties().styles[s], h = "Change " + s,
        b = $('<tr class="line"/>');
      b.appendTo(this._table), o = $("<td/>"), o.appendTo(b), o.addClass("visibility-cell"), i = $("<input type='checkbox' class='visibility-switch'/>"), i.appendTo(o), n = $.t(this._study.properties().styles[s].title.value(), {context: "input"}),
        this.createLabeledCell(n, i).appendTo(b).addClass("propertypage-name-label"), a = $("<td/>"), a.appendTo(b), a.addClass("colorpicker-cell"), r = g(a), l = $("<td/>"), l.appendTo(b), l.addClass("colorpicker-cell"), p = g(l), this.bindControl(new c(i, d.visible, !0, this.model(), h)), this.bindControl(new u(r, d.colorup, !0, this.model(), h, d.transparency)), this.bindControl(new u(p, d.colordown, !0, this.model(), h, d.transparency))
    }, i.prototype._findPlotPalette = function (e, t) {
      var o, i = e, n = t.id, a = null, r = null, l = this._study.metaInfo().plots;
      if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i)) a = this._study.metaInfo().palettes[t.palette], r = this._study.properties().palettes[t.palette]; else for (o = 0; o < l.length; o++)if (l[o].target === n && (this._study.isSelfColorerPlot(o) || this._study.isOHLCColorerPlot(o))) {
        a = this._study.metaInfo().palettes[l[o].palette], r = this._study.properties().palettes[l[o].palette];
        break
      }
      return {palette: a, paletteProps: r}
    }, i.prototype._prepareStudyPropertiesLayout = function () {
      var e, t, o = $('<table class="property-page study-properties" cellspacing="0" cellpadding="2">');
      return this._study.metaInfo().is_price_study || (e = this.createPrecisionEditor(), t = $("<tr>"), t.appendTo(o), $("<td>" + $.t("Precision") + "</td>").appendTo(t), $("<td>").append(e).appendTo(t), this.bindControl(new h(e, this._study.properties().precision, null, !0, this.model(), "Change Precision"))), "Compare@tv-basicstudies" === this._study.metaInfo().id && (e = this.createSeriesMinTickEditor(), t = $("<tr>"), t.appendTo(o), $("<td>" + $.t("Override Min Tick") + "</td>").appendTo(t), $("<td>").append(e).appendTo(t), this.bindControl(new h(e, this._study.properties().minTick, null, !0, this.model(), "Change MinTick"))), this._putStudyDefaultStyles(o), o
    }, i.prototype._putStudyDefaultStyles = function (e, t) {
      var o, i, n, a, r, l, p = null, s = this._study;
      return (!s.properties().linkedToSeries || !s.properties().linkedToSeries.value()) && ($.each(this._model.m_model.panes(), function (e, t) {
          $.each(t.dataSources(), function (e, o) {
            if (o === s)return p = t, !1
          })
        }), this._pane = p, this._pane && (-1 !== this._pane.leftPriceScale().dataSources().indexOf(this._study) ? o = "left" : -1 !== this._pane.rightPriceScale().dataSources().indexOf(this._study) ? o = "right" : this._pane.isOverlay(this._study) && (o = "none")), o && (i = this, n = {
          left: $.t("Scale Left"),
          right: $.t("Scale Right")
        }, i._pane.actionNoScaleIsEnabled(s) && (n.none = $.t("Screen (No Scale)")), a = this.createKeyCombo(n).val(o).change(function () {
          switch (this.value) {
            case"left":
        ...
        }), r = this.addRow(e), $("<td>" + $.t("Scale") + "</td>").appendTo(r), l = $("<td>").appendTo(r).append(a), t && t > 2 && l.attr("colspan", t - 1)), e)
    }, i.prototype.widget = function () {
      return this._table
    }, i.prototype._prepareFilledAreaBackground = function (e, t, o, i, n) {
      var a, r, l, p = $('<tr class="line"/>'), s = $("<td/>");
      return s.appendTo(p), a = $("<input type='checkbox' class='visibility-switch'/>"), a.appendTo(s), this.createLabeledCell(i, a).appendTo(p).addClass("propertypage-name-label"),
        r = $("<td/>"), r.appendTo(p), r.addClass("colorpicker-cell"), l = g(r), this.bindControl(new c(a, e, !0, this.model(), n + " visibility")), this.bindControl(new u(l, t, !0, this.model(), n + " color", o)), p
    }, inherit(n, r), n.prototype.prepareLayout = function () {
      if (this._study.properties().linkedToSeries && this._study.properties().linkedToSeries.value())return void(this._table = $());
      this._table = $()
    }, n.prototype.widget = function () {
      return this._table
    }, i._createRow_horizlines = function (e, t) {
      var o = this.addRow(e), i = t.name.value(), n = $("<input type='checkbox' class='visibility-switch'/>"),
        a = this.createColorPicker(), r = m(), l = w();
      $("<td>").append(n).appendTo(o), this.createLabeledCell(i, n).appendTo(o), $("<td>").append(a).appendTo(o), $("<td>").append(r).appendTo(o), $("<td>").append(l.render()).appendTo(o), this.bindControl(new c(n, t.visible, !0, this.model(), "Change " + i + " visibility")), this.bindControl(new u(a, t.color, !0, this.model(), "Change " + i + " color")), this.bindControl(new h(l, t.style, parseInt, !0, this.model(), "Change " + i + " style")), this.bindControl(new C(r, t.width, !0, this.model(), "Change " + i + " width"))
    }, i._createRow_vertlines = function (e, t) {
      var o = this.addRow(e), i = t.name.value(), n = $("<input type='checkbox' class='visibility-switch'/>"),
        a = this.createColorPicker(), r = m(), l = w();
      $("<td>").append(n).appendTo(o), this.createLabeledCell(i, n).appendTo(o), $("<td>").append(a).appendTo(o), $("<td>").append(r).appendTo(o), $("<td>").append(l.render()).appendTo(o), this.bindControl(new c(n, t.visible, !0, this.model(), "Change " + i + " visibility")), this.bindControl(new u(a, t.color, !0, this.model(), "Change " + i + " color")), this.bindControl(new h(l, t.style, parseInt, !0, this.model(), "Change " + i + " style")), this.bindControl(new C(r, t.width, !0, this.model(), "Change " + i + " width"))
    }, i._createRow_lines = function (e, t) {
      var o = this.addRow(e), i = t.title.value(), n = $("<input type='checkbox' class='visibility-switch'/>"),
        a = this.createColorPicker(), r = m(), l = w();
      $("<td>").append(n).appendTo(o), this.createLabeledCell(i, n).appendTo(o), $("<td>").append(a).appendTo(o), $("<td>").append(r).appendTo(o), $("<td>").append(l.render()).appendTo(o), this.bindControl(new c(n, t.visible, !0, this.model(), "Change " + i + " visibility")), this.bindControl(new u(a, t.color, !0, this.model(), "Change " + i + " color")), this.bindControl(new h(l, t.style, parseInt, !0, this.model(), "Change " + i + " style")), this.bindControl(new C(r, t.width, !0, this.model(), "Change " + i + " width"))
    }, i._createRow_hlines = function (e, t) {
      var o, i, n, a = this.addRow(e), r = t.name.value(), l = $("<input type='checkbox' class='visibility-switch'/>"),
        p = this.createColorPicker(), s = m(), d = w(), b = $("<input type='checkbox'>");
      $("<td>").append(l).appendTo(a), this.createLabeledCell(r, l).appendTo(a), $("<td>").append(p).appendTo(a), $("<td>").append(s).appendTo(a), $("<td>").append(d.render()).appendTo(a), $("<td>").appendTo(a), $("<td>").append(b).appendTo(a), this.createLabeledCell("Show Price", b).appendTo(a), this.bindControl(new c(l, t.visible, !0, this.model(), "Change " + r + " visibility")), this.bindControl(new u(p, t.color, !0, this.model(), "Change " + r + " color")),
        this.bindControl(new h(d, t.style, parseInt, !0, this.model(), "Change " + r + " style")), this.bindControl(new C(s, t.width, !0, this.model(), "Change " + r + " width")), this.bindControl(new c(b, t.showPrice, !0, this.model(), "Change " + r + " show price")), t.enableText.value() && (a = this.addRow(e), $('<td colspan="2">').appendTo(a), o = $("<input type='checkbox'>"), $('<td class="text-center">').append(o).appendTo(a), this.createLabeledCell("Show Text", o).appendTo(a), this.bindControl(new c(o, t.showText, !0, this.model(), "Change " + r + " show text")), i = TradingView.createTextPosEditor(), $("<td>").append(i.render()).appendTo(a), this.bindControl(new h(i, t.textPos, parseInt, !0, this.model(), "Change " + r + " text position")), n = this.createFontSizeEditor(), $('<td colspan="2">').append(n).appendTo(a), this.bindControl(new h(n, t.fontSize, parseInt, !0, this.model(), "Change " + r + " font size")))
    }, i._createRow_hhists = function (e, t) {
      var o, i, n, a, r, d, b = t.title.value(), C = [], g = [], w = this.addRow(e), T = f();
      $("<td>").append(T).appendTo(w), this.createLabeledCell(b, T).appendTo(w), this.bindControl(new c(T, t.visible, !0, this.model(), "Change " + b + " Visibility")), w = this.addRow(e), o = $("<input/>"), o.attr("type", "text"), o.addClass("ticker"), this.createLabeledCell($.t("Width (% of the Box)"), o).appendTo(w), $("<td>").append(o).appendTo(w), i = [s(40)], i.push(l(0)), i.push(p(100)), this.bindControl(new y(o, t.percentWidth, i, !1, this.model(), "Change Percent Width")), w = this.addLabeledRow(e, "Placement"), n = L(), $("<td>").append(n).appendTo(w), this.bindControl(new h(n, t.direction, null, !0, this.model(), "Change " + b + " Placement")), w = this.addRow(e), a = $("<input type='checkbox'>"), $("<td>").append(a).appendTo(w), this.createLabeledCell($.t("Show Values"), a).appendTo(w), this.bindControl(new c(a, t.showValues, !0, this.model(), "Change " + b + " Show Values")), w = this.addRow(e), r = this.createColorPicker(), this.createLabeledCell($.t("Text Color"), r).appendTo(w), $("<td>").append(r).appendTo(w), this.bindControl(new u(r, t.valuesColor, !0, this.model(), "Change " + b + " Text Color"));
      for (d in t.colors)isNumber(parseInt(d, 10)) && (w = this.addRow(e), C[d] = t.titles[d].value(), g[d] = this.createColorPicker(), $("<td>").append(C[d]).appendTo(w), $("<td>").append(g[d]).appendTo(w), this.bindControl(new u(g[d], t.colors[d], !0, this.model(), "Change " + C[d] + " color")))
    }, i._createRow_backgrounds = function (e, t) {
      var o = this.addRow(e), i = $("<input type='checkbox' class='visibility-switch'/>"), n = t.name.value(),
        a = this.createColorPicker();
      $("<td>").append(i).appendTo(o), this.createLabeledCell(n, i).appendTo(o), $("<td>").append(a).appendTo(o), this.bindControl(new c(i, t.visible, !0, this.model(), "Change " + n + " visibility")), this.bindControl(new u(a, t.color, !0, this.model(), "Change " + n + " color", t.transparency))
    }, i._createRow_polygons = function (e, t) {
      var o = this.addRow(e), i = t.name.value(), n = this.createColorPicker();
      $("<td>").append(i).appendTo(o), $("<td>").append(n).appendTo(o), this.bindControl(new u(n, t.color, !0, this.model(), "Change " + i + " color"))
    }, i._createRow_trendchannels = function (e, t) {
      var o = this.addRow(e), i = t.name.value(), n = this.createColorPicker()
      ;$("<td>").append(i).appendTo(o), $("<td>").append(n).appendTo(o), this.bindControl(new u(n, t.color, !0, this.model(), "Change " + i + " color", t.transparency))
    }, i._createRow_textmarks = function (e, t) {
      var o = this.addLabeledRow(e), i = t.name.value(), n = this.createColorPicker(), a = this.createColorPicker(),
        r = this.createFontEditor(), l = this.createFontSizeEditor(),
    ...
    var a = o(14), r = o(81), l = o(10), p = l.PropertyPage, s = l.SliderBinder, d = o(65).createTransparencyEditor,
      h = o(121);
    inherit(i, r), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, l = $('<table class="property-page" cellspacing="0" cellpadding="0">'),
      ...
      this._table = l.add(p), r.prototype.prepareLayoutForTable.call(this, l), e = $("<tr>").appendTo(p), $("<td>").append($.t("Avg HL in minticks")).appendTo(e), t = $("<td>").appendTo(e),
      ...
      return this._table
    }, inherit(n, a), n.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r, l, p, h, c;
      this._widget = $("<div>"), e = $("<table cellspacing=4>").appendTo(this._widget), t = this.createColorPicker(), o = this.createColorPicker(), i = this.createColorPicker(), n = this.createColorPicker(), a = this.createColorPicker(), r = $("<input type='checkbox' class='visibility-switch'/>").data("hides", $(n).add(a)), l = $("<input type='checkbox' class='visibility-switch'/>").data("hides", $(i)), p = this.addLabeledRow(e, $.t("Candles")), $("<td>").prependTo(p), $("<td>").append(t).appendTo(p), $("<td>").append(o).appendTo(p), p = this.addLabeledRow(e, $.t("Borders"), r), $("<td>").append(r).prependTo(p), $("<td>").append(n).appendTo(p), $("<td>").append(a).appendTo(p), $("<td>").appendTo(p), p = this.addLabeledRow(e, $.t("Wick"), l), $("<td>").append(l).prependTo(p), $("<td>").append(i).appendTo(p), $("<td>").appendTo(p), e = $("<table>").appendTo(this._widget), p = $("<tr>").appendTo(e), $("<td colspan='2'>").append($.t("Transparency")).appendTo(p), h = d(), $("<td colspan='2'>").append(h).appendTo(p), c = this._linetool.properties(), this.bindColor(t, c.candleStyle.upColor, "Change Candle Up Color"), this.bindColor(o, c.candleStyle.downColor, "Change Candle Down Color"), this.bindBoolean(l, c.candleStyle.drawWick, "Change Candle Wick Visibility"), this.bindColor(i, c.candleStyle.wickColor, "Change Candle Wick Color"), this.bindBoolean(r, c.candleStyle.drawBorder, "Change Candle Border Visibility"), this.bindColor(n, c.candleStyle.borderUpColor, "Change Candle Up Border Color"), this.bindColor(a, c.candleStyle.borderDownColor, "Change Candle Down Border Color"), this.bindControl(new s(h, c.transparency, !0, this.model(), "Change Guest Feed Transparency"))
    }, n.prototype.widget = function () {
      return this._widget
    }, t.LineToolGhostFeedInputsPropertyPage = i, t.LineToolGhostFeedStylesPropertyPage = n
  }, 400: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
      a.call(this, e, t, o), this.prepareLayout()
    ...
    var a = o(14), r = o(81), l = o(10), p = l.BooleanBinder, s = l.SimpleComboBinder, d = l.SimpleStringBinder,
      h = l.ColorBinding, c = l.SliderBinder, b = o(31).createLineStyleEditor, u = o(15).createLineWidthEditor;
    inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r, l, C, y, g, w, T, _;
      this._res = $("<div>"), this._table = $('<table class="property-page" cellspacing="0" cellpadding="2" style="width:100%"></table>').appendTo(this._res), e = u(), t = b(), o = this.createColorPicker(), i = this.addLabeledRow(this._table, "Line"), $("<td>").append(o).appendTo(i), $("<td>").append(e).appendTo(i), $('<td colspan="3">').append(t.render().css("display", "block")).appendTo(i), n = $("<input type='checkbox' class='visibility-switch'>"),
      ...
      var e, t, o, i
      ;this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), (e = this._linetool.points()[0]) && (t = this._linetool.properties().points[0], o = this.createPriceEditor(t.price), i = $("<tr>").appendTo(this._table), $("<td>" + $.t("Price") + "</td>").appendTo(i), $("<td>").append(o).appendTo(i), this.loadData())
    }, t.LineToolHorzLineStylesPropertyPage = i, t.LineToolHorzLineInputsPropertyPage = n
  }, 401: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
    ...
    var a = o(14), r = o(81), l = o(10), p = l.LessTransformer, s = l.GreateTransformer, d = l.ToIntTransformer,
      h = l.ToFloatTransformer, c = l.SimpleStringBinder, b = l.ColorBinding, u = l.SliderBinder,
      C = l.SimpleComboBinder, y = l.BooleanBinder, g = o(15).createLineWidthEditor, w = o(38).NumericFormatter;
    inherit(i, r), i.prototype.prepareLayout = function () {
      function e(e) {
    ...
    inherit(i, a), i.prototype.prepareLayout = function () {
      ...
      var e, t, o, i, n, a;
      this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), e = this._linetool.points()[0], t = this._linetool.properties().points[0], e && t && (o = this._createPointRow(e, t, ""), this._table.append(o), o = $("<tr>").appendTo(this._table), $("<td>").append($.t("Angle")).appendTo(o), i = $("<input type='text'>"), $("<td>").append(i).appendTo(o), n = [d(t.price.value()), p(-360), s(360)], a = new u(i, this._linetool.properties().angle, n, !1, this.model(), "Change angle"), a.addFormatter(function (e) {
        return (new w).format(e)
      }), this.bindControl(a), this.loadData())
    }, n.prototype.widget = function () {
      return this._table
    }, t.LineToolTrendAngleStylesPropertyPage = i, t.LineToolTrendAngleInputsPropertyPage = n
  }, 403: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
      a.call(this, e, t, o), this.prepareLayout()
    ...
    var a = o(14), r = o(81), l = o(10), p = l.BooleanBinder, s = l.SimpleComboBinder, d = l.SliderBinder,
      h = l.ColorBinding, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor;
    inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
    ...
    }, t.LineToolVertLineStylesPropertyPage = i, t.LineToolVertLineInputsPropertyPage = n
  }, 407: function (e, t, o) {
    (function (t) {
      "use strict";
      function i() {
      ...
      var n = o(10), a = n.PropertyPage, r = n.GreateTransformer, l = n.LessTransformer, p = n.ToIntTransformer,
        s = n.ToFloatTransformer, d = n.SimpleStringBinder, h = n.SimpleComboBinder, c = n.ColorBinding,
        b = n.BooleanBinder, u = n.SliderBinder, C = o(71), y = o(15).createLineWidthEditor,
        g = o(1121).createPriceSourceEditor, w = o(38).NumericFormatter;
      inherit(i, a), i.prototype.i18nCache = [window.t("Style"), window.t("Box size assignment method"), window.t("Color bars based on previous close"), window.t("Candles"), window.t("Borders"), window.t("Wick"), window.t("HLC Bars"), window.t("Price Source"), window.t("Type"), window.t("Show real prices on price scale (instead of Heikin-Ashi price)"), window.t("Up bars"), window.t("Down bars"), window.t("Projection up bars"), window.t("Projection down bars"), window.t("Line"), window.t("Fill"), window.t("Up Color"), window.t("Down Color"), window.t("Traditional"), window.t("ATR Length"), window.t("Number Of Line"), window.t("Reversal Amount"), window.t("Box Size")], i.prototype.getInputTitle = function (e, t) {
        return "style" === e ? window.t("Box size assignment method") : "boxSize" === e ? window.t("Box Size") : t.inputInfo ? t.inputInfo[e].name.value() : e.toLowerCase().replace(/\b\w/g, function (e) {
        ...
        for (i = i || {}, c = {}, b = this, u = 0; u < e.inputs.length; u++) {
          C = e.inputs[u], y = C.id, T = "BarSetRenko@tv-prostudies" === e.name || "BarSetKagi@tv-prostudies" === e.name || "BarSetPriceBreak@tv-prostudies" === e.name, "BarSetPnF@tv-prostudies" === e.name && "sources" === y && (C.options = C.options.filter(function (e) {
            return "HL" === e || "Close" === e
          }));
          try {
          ...
          if (("BarSetRenko@tv-prostudies" !== e.name || "wicks" !== y) && (!T || "source" !== y)) {
            if (_ = $("<tr/>"), C.isHidden || _.appendTo(t), m = $("<td" + (i.nameColspan ? ' colspan = "' + i.nameColspan + '"' : "") + "/>"), m.appendTo(_), m.addClass("propertypage-name-label"), m.text($.t(g)), f = $("<td" + (i.valueColspan ? ' colspan = "' + i.valueColspan + '"' : "") + "/>"), f.appendTo(_), L = null, C.options)for (L = $("<select/>"), v = 0; v < C.options.length; v++)k = C.options[v], $("<option value='" + k + "'>" + $.t(k) + "</option>").appendTo(L); else L = $("<input/>"), "bool" === C.type ? L.attr("type", "checkbox") : L.attr("type", "text");
            L.appendTo(f), L.css("width", "100px"), S = "Change " + g, C.options ? this.bindControl(new h(L, o.inputs[y], null, !0, this.model(), S)) : "integer" === C.type ? (P = [p(C.defval)], C.min && P.push(r(C.min)), C.max && P.push(l(C.max)),
              this.bindControl(new d(L, o.inputs[y], P, !1, this.model(), S)), L.addClass("ticker")) : "float" === C.type ? (P = [s(C.defval)], C.min && ((("BarSetRenko@tv-prostudies" === e.id || "BarSetPnF@tv-prostudies" === e.id) && "boxSize" === C.id || "BarSetKagi@tv-prostudies" === e.id && "reversalAmount" === C.id) && (B = this._model.model().mainSeries().symbolInfo(), x = B.minmov / B.pricescale), P.push(r(x || C.min))), C.max && P.push(l(C.max)), E = new d(L, o.inputs[y], P, !1, this.model(), S), E.addFormatter(a), this.bindControl(E), L.addClass("ticker")) : "text" === C.type && this.bindControl(new d(L, this._property.inputs[y], null, !1, this.model(), S)), L.change(n), c[C.id] = _
          }
        }
        this.refreshStateControls(c, e.inputs, o.inputs)
      }, i.prototype.getMetaInfo = function (e) {
        var t, o = this._model.m_model._studiesMetaData;
        ...
        var a, s, w, T, _, m, f, L, v, k, S, P, x, B, E, R, F, I, A, D, W, O, V, j, z, M, H, q, N, G, U, Y, K, Q, J, Z,
          X, ee, te, oe, ie, ne, ae, re, le, pe, se, de, he, ce, be, ue, Ce, ye, ge, $e, we, Te, _e, me, fe, Le, ve, ke,
          Se, Pe, xe, Be, Ee, Re, Fe, Ie, Ae, De, We, Oe, Ve, je, ze, Me = $("<tbody>").appendTo(e),
          He = this._candlesColorerTbody = $("<tbody>").appendTo(o),
          qe = this._barsColorerTbody = $("<tbody>").appendTo(o), Ne = this._haColorerTbody = $("<tbody>").appendTo(o),
          Ge = this._candlesTbody = $("<tbody>").appendTo(i), Ue = this._hollowCandlesTbody = $("<tbody>").appendTo(i),
          Ye = this._haTbody = $("<tbody>").appendTo(i), Ke = this._barsTbody = $("<tbody>").appendTo(i),
          Qe = this._lineTbody = $("<tbody>").appendTo(i), Je = this._areaTbody = $("<tbody>").appendTo(i),
          Ze = this._renkoTbody = $("<tbody>").appendTo(i), Xe = this._pbTbody = $("<tbody>").appendTo(i),
          et = this._kagiTbody = $("<tbody>").appendTo(i), tt = this._pnfTbody = $("<tbody>").appendTo(i),
          ot = this._baselineTbody = $("<tbody>").appendTo(i), it = this.addLabeledRow(Me, "Style"),
          nt = $(document.createElement("td")).appendTo(it);
        nt.addClass("property-wide-select"), a = $(document.createElement("select")), $("<option value=" + C.STYLE_BARS + ">" + $.t("Bars") + "</option>").appendTo(a), $("<option value=" + C.STYLE_CANDLES + ">" + $.t("Candles") + "</option>").appendTo(a), $("<option value=" + C.STYLE_HOLLOW_CANDLES + ">" + $.t("Hollow Candles") + "</option>").appendTo(a), this._isJapaneseChartsAvailable() && $("<option value=" + C.STYLE_HEIKEN_ASHI + ">" + $.t("Heikin Ashi") + "</option>").appendTo(a), $("<option value=" + C.STYLE_LINE + ">" + $.t("Line") + "</option>").appendTo(a), $("<option value=" + C.STYLE_AREA + ">" + $.t("Area") + "</option>").appendTo(a), $("<option value=" + C.STYLE_BASELINE + ">" + $.t("Baseline") + "</option>").appendTo(a), a.css("width", "100px").appendTo(nt), this.switchStyle(), s = function (e) {
          this._undoModel.setChartStyleProperty(this._property, e, this._undoText)
        }, this.bindControl(new h(a, n.style, parseInt, !0, this.model(), "Change Series Style", s)), n.style.listeners().subscribe(this, this.switchStyle), w = this.createColorPicker(), T = this.createColorPicker(), _ = this.createColorPicker(), m = this.createColorPicker(), f = this.createColorPicker(), L = this.createColorPicker(),
    ...
    function i() {
      var e = $("<select />");
      return $('<option value="' + n.PlotType.Line + '">' + $.t("Line") + "</option>").appendTo(e), $('<option value="' + n.PlotType.LineWithBreaks + '">' + $.t("Line With Breaks") + "</option>").appendTo(e), $('<option value="' + n.PlotType.Histogram + '">' + $.t("Histogram") + "</option>").appendTo(e),
        $('<option value="' + n.PlotType.Cross + '">' + $.t("Cross", {context: "chart_type"}) + "</option>").appendTo(e), $('<option value="' + n.PlotType.Area + '">' + $.t("Area") + "</option>").appendTo(e), $('<option value="' + n.PlotType.AreaWithBreaks + '">' + $.t("Area With Breaks") + "</option>").appendTo(e), $('<option value="' + n.PlotType.Columns + '">' + $.t("Columns") + "</option>").appendTo(e), $('<option value="' + n.PlotType.Circles + '">' + $.t("Circles") + "</option>").appendTo(e), e
    }
    ...
    "use strict";
    function i(e) {
      return this.jqObj = null, this.data = e, this.init(), this._prepareValue(), this._prepareCallback(), this._prepareChildren(), this._applyAttributes(), this.jqObj
    }
    ...
    function a(e) {
      this._value = null, this.items = [], this.width = 0, this.jqWrapper = null, this.jqSwitcher = null, this.jqTitle = null, this.jqIcon = null, this.jqItems = null, this.callbacks = [], this._init(), this.addItems(e), this.joinParts()
    }

    var r = o(206);
    i.selectOptions = {type: "option", value: null, html: null}, i.optionsData = {
      radiogroup: {
        type: "radio",
        name: null,
        value: null,
        label: null
      }, select: i.selectOptions, "select-one": i.selectOptions, "select-multiple": i.selectOptions
    }, i.customTypes = ["radiogroup", "fontpicker", "colorpicker", "combobox"], i.prototype._tagIsInput = function (e) {
      return -1 !== jQuery.inArray(this.data.type, ["text", "radio", "checkbox", "hidden", "reset", "image", "file"])
    }, i.prototype.init = function () {
      this._tagIsInput() ? this.jqObj = r.create("input", {
        name: this.data.name,
        type: this.data.type
      ...
      this._setControlValue(), i.isCheckable(this.data.type) && this._setChecked()
      ...
      var t, o;
      return "string" == typeof e ? e : (t = jQuery(e), o = null, t.attr("type") && (o = t.attr("type"), jQuery.inArray(o, ["textarea", "text", "select", "select-one", "select-multiple", "submit"])) ? o : t.attr("tagName"))
      ...
      return i.controlCheckable(e) ? i.controlToggleChecked(e, t) : o(205).setAttr(e, "value", t)
      ...
      e ? this.jqItem.addClass("selected") : this.jqItem.removeClass("selected")
      ...
      var e = this;
      this._initTitle(), this._initIcon(), this.jqSwitcher = $('<div class="switcher" />'), this.jqSwitcher.append(this.jqTitle), this.jqSwitcher.append($(this.jqIcon).clone()), this.opened = !1,
        this.jqSwitcher.click(function (t) {
          e.toggleItems()
        }), e = this, $(document).click(function (t) {
        $(t.target).closest(e.jqSwitcher).length || (!e.jqSwitcher.is(t.target) && 0 === e.jqSwitcher.has(t.target).length || !e.jqItems.is(t.target) && 0 === !e.jqItems.has(t.target).length) && e.opened && (e.jqItems.hide(), e.opened = !1, e.jqSwitcher.removeClass("open"), t.stopPropagation())
      })
      ...
      var t = null;
      return $(this.items).each(function (o, i) {
      ...
      var o, i = this, a = new n(e, t);
      this.items.push(a), o = a.render(), o.click(function () {
        i.setValue(e), i.toggleItems()
      }), this.jqItems.append(o), null === this.value() && this.setValue(e)
    ...
    }, t.Input = i, t.Combobox = a
  }, 746: function (e, t, o) {
    (function (t) {
      "use strict";
      function i(e, t, o) {
        var i, n, a = t.m_model.properties();
        l.call(this, a, t), i = this._series = t.mainSeries(), this._chart = t.m_model, this._model = t, this._source = o, this._property = a, this._seriesProperty = i.properties(), this._scaleProperty = i.m_priceScale.properties(), this._mainAxisProperty = i.properties().priceAxisProperties, n = null, $.each(t.m_model.panes(), function (e, t) {
          $.each(t.dataSources(), function (e, o) {
            if (o === i)return n = t, !1
          })
        }), this._pane = n, this.prepareLayout(), this._themes = [], this.supportThemeSwitcher = !1
      }

      var n = o(407), a = (o(76).UndoHistory, o(121)), r = o(10), l = r.PropertyPage, p = r.GreateTransformer,
        s = r.LessTransformer, d = r.ToIntTransformer, h = r.SimpleStringBinder, c = r.BooleanBinder,
        b = r.SliderBinder, u = r.ColorBinding, C = r.SimpleComboBinder, y = r.DisabledBinder, g = r.CheckboxWVBinding,
        w = o(71), T = o(37), _ = o(47).addColorPicker, m = o(31).createLineStyleEditor,
        f = o(15).createLineWidthEditor, L = (o(103).bindPopupMenu, o(11).DefaultProperty),
        v = o(226).availableTimezones, k = o(309);
      o(123).createConfirmDialog, o(13).getLogger("Chart.PropertyPage"), o(48).trackEvent;
      inherit(i, l), inherit(i, n), i.prototype.setScalesOpenTab = function () {
        ...
        var e, o, i, n, r, l, L, S, P, x, B, E, R, F, I, A, D, W, O, V, j, z, M, H, q, N, G, U, Y, K, Q, J, Z, X, ee,
          te, oe, ie, ne, ae, re, le, pe, se, de, he, ce, be, ue, Ce, ye, ge, $e, we, Te, _e, me, fe, Le, ve, ke, Se,
          Pe, xe, Be, Ee, Re, Fe, Ie, Ae, De, We, Oe, Ve, je, ze, Me, He, qe, Ne, Ge, Ue, Ye, Ke, Qe, Je, Ze, Xe, et,
          tt, ot, it, nt, at, rt, lt, pt, st, dt, ht, ct, bt, ut, Ct, yt, gt, $t, wt, Tt, _t, mt, ft, Lt, vt, kt, St,
          Pt, xt, Bt, Et, Rt, Ft, It, At, Dt, Wt, Ot, Vt = this;
        if (t.enabled("chart_property_page_style") && (e = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.style), o = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.style), i = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.style), this._prepareSeriesStyleLayout(e, o, i, this._seriesProperty), this._hasSeriesStyleLayout = !0, l = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.style), I = $('<input type="checkbox">'), A = this.addLabeledRow(l, $.t("Price Line"), I), $("<td>").append(I).prependTo(A), this.bindControl(new c(I, this._seriesProperty.showPriceLine, !0, this.model(), "Change Price Price Line")), D = _($("<td>").appendTo(A)), this.bindControl(new u(D, this._seriesProperty.priceLineColor, !0, this.model(), "Change Price Line Color")), W = f(), $('<td colspan="2">').append(W).appendTo(A), this.bindControl(new b(W, this._seriesProperty.priceLineWidth, !0, this.model(), "Change Price Line Width")), O = $('<input type="checkbox">'), V = this.addLabeledRow(l, $.t("Previous Close Price Line"), O), $("<td>").append(O).prependTo(V), this.bindControl(new c(O, this._seriesProperty.showPrevClosePriceLine, !0, this.model(), "Change Price Previous Close Price Line")), this.bindControl(new y(O, this._series.isPrevClosePriceAvailable(), !0, this.model(), "Change Price Previous Close Price Line", !0)), j = this.createColorPicker(), $("<td>").append(j).appendTo(V), this.bindControl(new u(j, this._seriesProperty.prevClosePriceLineColor, !0, this.model(), "Change Previous Close Price Line Color")), W = f(), $("<td>").append(W).appendTo(V), this.bindControl(new b(W, this._seriesProperty.prevClosePriceLineWidth, !0, this.model(), "Change Previous Close Price Line Width")), S = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.style), this._pane && (-1 !== this._pane.leftPriceScale().dataSources().indexOf(this._series) ? z = "left" : -1 !== this._pane.rightPriceScale().dataSources().indexOf(this._series) ? z = "right" : this._pane.isOverlay(this._series) && (z = "none")), z && (M = {
            left: $.t("Scale Left"),
            right: $.t("Scale Right")
          }, Vt._pane.actionNoScaleIsEnabled(Vt._series) && (M.none = $.t("Screen (No Scale)")), H = this.createKeyCombo(M).val(z).change(function () {
            switch (this.value) {
              case"left":
                Vt._model.move(Vt._series, Vt._pane, Vt._pane.leftPriceScale());
                break;
              case"right":
                Vt._model.move(Vt._series, Vt._pane, Vt._pane.rightPriceScale());
                break
                  ;
              case"none":
                Vt._model.move(Vt._series, Vt._pane, null)
            }
          }), q = this.addRow(S), $("<td>" + $.t("Scale") + "</td>").appendTo(q), $("<td>").appendTo(q).append(H))), t.enabled("chart_property_page_scales") && (N = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.scales), G = $('<input type="checkbox">').change(function () {
            this.checked && setTimeout(function () {
              Vt._model.m_model.invalidate(new T(T.LIGHT_UPDATE))
            }, 0)
          }), U = this.addLabeledRow(N, $.t("Auto Scale"), G), Y = function (e) {
            this._undoModel.setAutoScaleProperty(this._property, e, Vt._series.priceScale(), this._undoText)
          }, $("<td>").append(G).prependTo(U), this.bindControl(new c(G, this._scaleProperty.autoScale, !0, this.model(), "Auto Scale", Y)), this.bindControl(new y(G, this._scaleProperty.autoScaleDisabled, !0, this.model(), "Auto Scale")), K = $('<input type="checkbox">'), Q = this.addLabeledRow(N, $.t("Percentage"), K), J = function (e) {
            this._undoModel.setPercentProperty(this._property, e, Vt._series.priceScale(), this._undoText)
          }, $("<td>").append(K).prependTo(Q), this.bindControl(new c(K, this._mainAxisProperty.percentage, !0, this.model(), "Scale Percentage", J)), this.bindControl(new y(K, this._mainAxisProperty.percentageDisabled, !0, this.model(), "Scale Percentage")), Z = $('<input type="checkbox">'), X = this.addLabeledRow(N, $.t("Log Scale"), Z), ee = function (e) {
            this._undoModel.setLogProperty(this._property, e, Vt._series.priceScale(), this._undoText)
          }, $("<td>").append(Z).prependTo(X), this.bindControl(new c(Z, this._mainAxisProperty.log, !0, this.model(), "Log Scale", ee)), this.bindControl(new y(Z, this._mainAxisProperty.logDisabled, !0, this.model(), "Log Scale")), te = $('<input type="checkbox">').change(function () {
            this.checked && setTimeout(function () {
              Vt._model.m_model.invalidate(new T(T.LIGHT_UPDATE))
            }, 0)
          }), oe = this.addLabeledRow(N, $.t("Scale Series Only"), te), $("<td>").append(te).prependTo(oe), this.bindControl(new c(te, this._property.scalesProperties.scaleSeriesOnly, !0, this.model(), "Scale Series Only")), ie = $("<input type='checkbox'/>"), ne = this.addLabeledRow(N, $.t("Lock scale"), ie), ae = function (e) {
            this._undoModel.setLockScaleProperty(this._property, e, Vt._series, this._undoText)
          }, re = function (e) {
            ne.toggle(e.value() === w.STYLE_PNF)
          }, $("<td>").append(ie).prependTo(ne), this.bindControl(new c(ie, this._seriesProperty.lockScale, !0, this.model(), "Change lock scale", ae)), this._seriesProperty.style.listeners().subscribe(this, re), t.enabled("support_multicharts") && (le = $("<input type='checkbox'/>"), pe = this.addLabeledRow(N, $.t("Track time"), le), $("<td>").append(le).prependTo(pe), this.bindControl(new g(le, this._model.trackTime(), null, "Change track time"))), se = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.scales), de = $('<input type="text" class="ticker">'), he = this.addLabeledRow(se, $.t("Top Margin"), de), $("<td>").appendTo(he).append(de), $("<td>%</td>").appendTo(he), ce = [d(this._property.paneProperties.topMargin.value())], ce.push(s(25)), ce.push(p(0)), this.bindControl(new h(de, this._property.paneProperties.topMargin, ce, !0, this.model(), "Top Margin")),
            be = $('<input type="text" class="ticker">'), ue = this.addLabeledRow(se, $.t("Bottom Margin"), be), $("<td>").appendTo(ue).append(be), $("<td>%</td>").appendTo(ue), Ce = [d(this._property.paneProperties.bottomMargin.value())], Ce.push(s(25)), Ce.push(p(0)), this.bindControl(new h(be, this._property.paneProperties.bottomMargin, Ce, !0, this.model(), "Bottom Margin")), ye = $('<input type="text" class="ticker">'), ge = this.addLabeledRow(se, $.t("Right Margin"), ye), $("<td>").appendTo(ge).append(ye), $("<td>" + $.t("bars", {context: "margin"}) + "</td>").appendTo(ge), $e = [d(this._property.timeScale.rightOffset.value())], $e.push(s(~~this._chart.timeScale().maxRightOffset())), $e.push(p(-200)), this.bindControl(new h(ye, this._property.timeScale.rightOffset, $e, !0, this.model(), "Right Margin")), we = $('<table class="property-page" cellspacing="0" cellpadding="2">').data("layout-tab", a.TabNames.scales), Te = $("<input type='checkbox' />"), _e = this.addLabeledRow(we, $.t("Left Axis"), Te), $("<td>").append(Te).prependTo(_e), setTimeout(function () {
            this.bindControl(new c(Te, this._property.scalesProperties.showLeftScale, !0, this.model(), "Show Left Axis"))
          }.bind(this), 0), me = $("<input type='checkbox' />"), fe = this.addLabeledRow(we, $.t("Right Axis"), me), $("<td>").append(me).prependTo(fe), setTimeout(function () {
            this.bindControl(new c(me, this._property.scalesProperties.showRightScale, !0, this.model(), "Show Right Axis"))
          }.bind(this), 0), t.enabled("countdown") && (Le = $("<input type='checkbox'>"), ve = this.addLabeledRow(we, $.t("Countdown"), Le), $("<td>").append(Le).prependTo(ve), this.bindControl(new c(Le, this._seriesProperty.showCountdown, !0, this.model(), "Change Show Countdown"))), ke = $('<input type="checkbox">'), Se = this.addLabeledRow(we, $.t("Symbol Last Value"), ke), $("<td>").append(ke).prependTo(Se), this.bindControl(new c(ke, this._property.scalesProperties.showSeriesLastValue, !0, this.model(), "Change Symbol Last Value Visibility")), Pe = $('<input type="checkbox">'), xe = this.addLabeledRow(we, $.t("Symbol Prev. Close Value"), Pe), $("<td>").append(Pe).prependTo(xe), this.bindControl(new c(Pe, this._property.scalesProperties.showSeriesPrevCloseValue, !0, this.model(), "Change Symbol Previous Close Value Visibility")), this.bindControl(new y(Pe, this._series.isPrevClosePriceAvailable(), !0, this.model(), "Change Symbol Previous Close Value Visibility", !0)), Be = $('<input type="checkbox">'), Ee = this.addLabeledRow(we, $.t("Indicator Last Value"), Be), $("<td>").append(Be).prependTo(Ee), this.bindControl(new c(Be, this._property.scalesProperties.showStudyLastValue, !0, this.model(), "Change Indicator Last Value Visibility")), Re = $('<input type="checkbox">'), Fe = this.addLabeledRow(we, $.t("Symbol Labels"), Re), $("<td>").append(Re).prependTo(Fe), this.bindControl(new c(Re, this._property.scalesProperties.showSymbolLabels, !0, this.model(), "Show Symbol Labels")), Ie = $('<input type="checkbox">'), Ae = this.addLabeledRow(we, $.t("Indicator Labels"), Ie), $("<td>").append(Ie).prependTo(Ae), this.bindControl(new c(Ie, this._property.scalesProperties.showStudyPlotLabels, !0, this.model(), "Show Study Plots Labels")), De = $("<input type='checkbox' />"),
        ...
        return t.enabled("chart_property_page_template_button") ? (this, e || (e = {}), $('<a href="#" class="_tv-button">' + $.t("Template") + '<span class="icon-dropdown"></span></a>')) : $("<span />")
      }, i.prototype.switchStyle = function () {
        if (this._hasSeriesStyleLayout)switch ($(this._barsTbody).add(this._barsColorerTbody).add(this._renkoTbody).add(this._pbTbody).add(this._kagiTbody).add(this._pnfTbody).add(this._candlesTbody).add(this._candlesColorerTbody).add(this._hollowCandlesTbody).add(this._lineTbody).add(this._areaTbody).add(this._haTbody).add(this._haColorerTbody).add(this._baselineTbody).css("display", "none"), this._seriesProperty.style.value()) {
          case w.STYLE_BARS:
            this._barsTbody.css("display", "table-row-group"), this._barsColorerTbody.css("display", "table-row-group");
            break;
          case w.STYLE_CANDLES:
            this._candlesTbody.css("display", "table-row-group"), this._candlesColorerTbody.css("display", "table-row-group");
            break;
        ...
        var e, t = this._model.model().properties().paneProperties.topMargin,
          o = this._model.model().properties().paneProperties.bottomMargin;
        t.listeners().fire(t), o.listeners().fire(o), e = this._model.model().properties().timezone, e.listeners().fire(e)
      }, i.prototype.defaultProperties = function () {
        var e = this,
          t = [e._seriesProperty.extendedHours, e._property.scalesProperties.showLeftScale, e._property.scalesProperties.showRightScale, e._property.timeScale.rightOffset].map(function (e) {
    ...
    ;inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t;
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = this.createKeyCombo({
        open: $.t("Open"),
        high: $.t("High"),
        low: $.t("Low"),
        close: $.t("Close")
      }), t = this.addLabeledRow(this._table, $.t("Source", {context: "compare"})), $("<td>").appendTo(t).append(e), this.bindControl(new r(e, this._property.inputs.source, null, !0, this.model(), "Change Price Source")), this.loadData()
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 757: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.ColorBinding, p = a.SliderBinder, s = a.SimpleComboBinder,
      d = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      ...
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = d(), t = this.createColorPicker(), o = this.createColorPicker(), i = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'), n = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>'), a = this.createFontSizeEditor(), h = this.createFontEditor(), c = this.addLabeledRow(this._table, "Border"), c.prepend("<td>"), $("<td>").append(t).appendTo(c), $("<td>").append(e).appendTo(c), b = $('<input type="checkbox" class="visibility-switch">'), u = this.createColorPicker(), h = this.createFontEditor(), c = this.addLabeledRow(this._table, "Background", b), $("<td>").append(b).prependTo(c), $("<td>").append(u).appendTo(c), this.bindControl(new r(b, this._linetool.properties().fillBackground, !0, this.model(), "Change Pattern Filling")), this.bindControl(new l(t, this._linetool.properties().color, !0, this.model(), "Change Pattern Line Color")), this.bindControl(new l(o, this._linetool.properties().textcolor, !0, this.model(), "Change Pattern Text Color")), this.bindControl(new l(u, this._linetool.properties().backgroundColor, !0, this.model(), "Change Pattern Background Color", this._linetool.properties().transparency)), this.bindControl(new p(e, this._linetool.properties().linewidth, !0, this.model(), "Change Pattern Border Width")), this.bindControl(new s(a, this._linetool.properties().fontsize, parseInt, !0, this.model(), "Change Text Font Size")), this.bindControl(new s(h, this._linetool.properties().font, null, !0, this.model(), "Change Text Font")), this.bindControl(new r(i, this._linetool.properties().bold, !0, this.model(), "Change Text Font Bold")), this.bindControl(new r(n, this._linetool.properties().italic, !0, this.model(), "Change Text Font Italic")), C = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>').append($(document.createElement("td")).attr({width: 1}).append(o)).append($(document.createElement("td")).attr({width: 1}).append(h)).append($(document.createElement("td")).attr({width: 1}).append(a)).append($(document.createElement("td")).css("vertical-align", "top").attr({
        width: 1
      }).append(i)).append($(document.createElement("td")).css("vertical-align", "top").append(n)).append($("</tr></table>")), c = this.addLabeledRow(this._table, ""), $('<td colspan="5">').append(C).appendTo(c), this.loadData()
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 758: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.ColorBinding, l = a.SliderBinder, p = a.SimpleComboBinder, s = a.BooleanBinder,
      d = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.ColorBinding, p = a.SliderBinder,
      s = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = s(), t = this.createColorPicker(), o = this.addLabeledRow(this._table, "Border"),
    ...
    var n = o(14), a = o(10), r = a.SimpleComboBinder, l = a.ColorBinding, p = a.SimpleStringBinder,
      s = o(121).TabOpenFrom;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, d, h,
        c = $('<table class="property-page" cellspacing="0" cellpadding="0">').css({width: "100%"}).data("layout-tab-open", s.Override),
        b = $('<table class="property-page" cellspacing="0" cellpadding="0">');
      this._table = c.add(b), e = $("<input type='text'>").css({width: "100%"}), t = this.createColorPicker(), o = this.createFontSizeEditor(), i = this.createColorPicker(), n = this.createColorPicker(), a = $("<tr>").appendTo(c), d = $('<div class="property-page-fullwidth-wrapper">').append(e), $("<td>").append(d).appendTo(a), h = this.addLabeledRow(b, $.t("Text")), $("<td>").append(t).appendTo(h), $("<td>").append(o).appendTo(h), h = this.addLabeledRow(b, $.t("Background")), $("<td>").appendTo(h).append(i), h = this.addLabeledRow(b, $.t("Border")),
    ...
    var a = o(14), r = o(81), l = o(10), p = l.ToFloatTransformer, s = l.SimpleComboBinder, d = l.ColorBinding,
      h = l.BooleanBinder, c = l.SimpleStringBinder;
    inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a;
      ...
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = $("<tr>"), e.appendTo(this._table), t = $("<td>"), t.html($.t("Price")), t.appendTo(e), o = $("<td>"), o.appendTo(e), i = $("<input type='text'>"), i.appendTo(o), n = $("<td>"), n.html($.t("Bar #")), n.appendTo(e), a = $("<td>"), a.appendTo(e), r = $("<input type='text'>"), r.appendTo(a),
        r.addClass("ticker"), l = this._linetool.properties().points[0], s = [p(l.price.value())], this.bindControl(new c(i, l.price, s, !1, this.model(), "Change " + this._linetool + " point price")), this.bindBarIndex(l.bar, r, this.model(), "Change " + this._linetool + " point bar index"), this.loadData()
    }, t.LineToolBarsPatternStylesPropertyPage = i, t.LineToolBarsPatternInputsPropertyPage = n
  }, 763: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout()
    ...
    var n = o(14), a = o(10), r = a.ColorBinding, l = a.SimpleComboBinder, p = a.SliderBinder, s = a.BooleanBinder,
      d = o(31).createLineStyleEditor, h = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
    ...
    var n = o(14), a = o(10), r = a.SliderBinder, l = a.BooleanBinder, p = a.ColorBinding, s = a.SimpleComboBinder,
      d = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, h, c;
      this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), e = d(), t = this.createColorPicker(), o = $('<input type="checkbox" class="visibility-switch">'), i = this.createColorPicker(), n = this.addLabeledRow(this._table, "Line"), $("<td>").prependTo(n), $("<td>").append(t).appendTo(n), $("<td>").append(e).appendTo(n), n = this.addLabeledRow(this._table, "Background", o), $("<td>").append(o).prependTo(n), $("<td>").append(i).appendTo(n), a = $("<tbody>").appendTo(this._table), h = $("<select><option value='0'>" + $.t("Normal") + "</option><option value='1'>" + $.t("Arrow") + "</option></select>"), c = $("<select><option value='0'>" + $.t("Normal") + "</option><option value='1'>" + $.t("Arrow") + "</option></select>"), n = this.addLabeledRow(a, $.t("Left End")), $("<td>").prependTo(n), $('<td colspan="3">').appendTo(n).append(h), n = this.addLabeledRow(a, $.t("Right End")), $("<td>").prependTo(n), $('<td colspan="3">').appendTo(n).append(c), this.bindControl(new p(t, this._linetool.properties().linecolor, !0, this.model(), "Change Brush Color")), this.bindControl(new r(e, this._linetool.properties().linewidth, !0, this.model(), "Change Brush Line Width")), this.bindControl(new l(o, this._linetool.properties().fillBackground, !0, this.model(), "Change Brush Filling")), this.bindControl(new p(i, this._linetool.properties().backgroundColor, !0, this.model(), "Change Brush Background Color", this._linetool.properties().transparency)), this.bindControl(new s(h, this._linetool.properties().leftEnd, parseInt, !0, this.model(), "Change Trend Line Left End")), this.bindControl(new s(c, this._linetool.properties().rightEnd, parseInt, !0, this.model(), "Change Trend Line Right End")), this.loadData()
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 765: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.ColorBinding, p = a.SimpleComboBinder, s = a.SliderBinder,
      d = a.SimpleStringBinder, h = o(15).createLineWidthEditor, c = o(121).TabOpenFrom;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n = this.createColorPicker(), a = this.createFontSizeEditor(), b = this.createFontEditor(),
        u = this.createTextEditor(350, 200), C = this.createColorPicker(), y = h(), g = this.createColorPicker(),
        w = $('<input type="checkbox">'),
        T = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
        _ = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>');
      this.bindControl(new l(n, this._linetool.properties().color, !0, this.model(), "Change Text Color")), this.bindControl(new p(a, this._linetool.properties().fontsize, parseInt, !0, this.model(), "Change Text Font Size")),
    ...
    var n = o(14), a = o(10), r = a.SimpleComboBinder, l = a.ColorBinding, p = a.SliderBinder,
      s = o(31).createLineStyleEditor, d = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i;
    ...
    inherit(i, n), i.prototype.prepareLayout = function () {
      ...
      this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), e = $("<tbody>").appendTo(this._table), t = d(), o = this.createColorPicker(), i = this.addLabeledRow(e, $.t("Line")), $("<td>").prependTo(i), $("<td>").append(o).appendTo(i), $("<td>").append(t).appendTo(i),
    ...
    var n = o(14), a = o(10), r = a.SimpleComboBinder, l = a.BooleanBinder, p = a.ColorBinding, s = a.SliderBinder,
      d = o(31).createLineStyleEditor, h = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, c, b, u, C, y, g, w, T, _, m, f, L, v, k, S, P, x, B;
    ...
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
      this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = s(), t = this.createColorPicker(), o = this.addLabeledRow(this._table, $.t("Border")),
    ...
    var n = o(14), a = o(10), r = a.FloatBinder, l = a.SimpleComboBinder, p = a.BooleanBinder, s = a.ColorBinding,
      d = a.SliderBinder, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, u, C, y, g, w, T, _, m = $("<tr>");
      m.appendTo(this._table), i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), e ? (a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : this.createLabeledCell("Trend Line", n).appendTo(m), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), w = b(), w.appendTo(g), e || (T = $("<td>"), T.appendTo(m), _ = c(), _.render().appendTo(T), this.bindControl(new l(_, t.linestyle, parseInt, !0, this.model(), "Change Fib Circle Style"))), this.bindControl(new p(n, t.visible, !0, this.model(), "Change Fib Circle Visibility")), this.bindControl(new s(y, t.color, !0, this.model(), "Change Fib Circle Line Color", 0)), this.bindControl(new d(w, t.linewidth, !0, this.model(), "Change Fib Circle Width"))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().trendline, !1), e = 1; e <= 11; e++)t = "level" + e, this.addLevelEditor("Level " + e, this._linetool.properties()[t], !1);
      this.addOneColorPropertyWidget(this._table), o = $("<input type='checkbox' class='visibility-switch'>"), i = this.addLabeledRow(this._table, "Levels", o), $("<td>").append(o).prependTo(i), n = $("<input type='checkbox' class='visibility-switch'>"), i = this.addLabeledRow(this._table, "Coeffs As Percents", n), $("<td>").append(n).prependTo(i), this.bindControl(new p(o, this._linetool.properties().showCoeffs, !0, this.model(), "Change Fib Circle Levels Visibility")), i = $("<tr>"),
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.ColorBinding, p = a.FloatBinder, s = a.SimpleComboBinder,
      d = a.SliderBinder, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, s, d, c, b = $("<tr>");
      b.appendTo(e), i = $("<td>"), i.appendTo(b), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), a = $("<td>"), a.appendTo(b), s = $("<input type='text'>"), s.appendTo(a), s.css("width", "70px"), this.bindControl(new r(n, o.visible, !0, this.model(), "Change Gann Square Line Visibility")), this.bindControl(new p(s, o.coeff, !1, this.model(), "Change Pitchfork Line Coeff")), d = $("<td class='colorpicker-cell'>"), d.appendTo(b), c = h(d), this.bindControl(new l(c, o.color, !0, this.model(), "Change Gann Square Line Color", 0))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, p, h, C, y, g, w, T, _, m, f, L, v, k, S, P, x, B;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page property-page-unpadded"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this._table.css({width: "100%"}), e = $("<tbody>").appendTo(this._table), t = $("<tr>"), t.appendTo(e), o = $('<td width="50%">'), o.appendTo(t), i = $('<td width="50%">'), i.appendTo(t), n = $('<table cellspacing="0" cellpadding="2">'), n.appendTo(o), n.addClass("property-page"), a = $('<table cellspacing="0" cellpadding="2">'), a.appendTo(i), a.addClass("property-page"), $("<tr><td align='center' colspan='4'>" + $.t("Price Levels") + "</td></tr>").appendTo(n), $("<tr><td align='center' colspan='4'>" + $.t("Time Levels") + "</td></tr>").appendTo(a), p = 1; p <= 7; p++)h = "hlevel" + p, this.addLevelEditor(n, "Level " + p, this._linetool.properties()[h]);
      for (p = 1; p <= 7; p++)h = "vlevel" + p, this.addLevelEditor(a, "Level " + p, this._linetool.properties()[h]);
      this.addOneColorPropertyWidget(n), i.css({"vertical-align": "top"}), C = $("<input type='checkbox' class='visibility-switch'>"), y = $("<input type='checkbox' class='visibility-switch'>"), g = $("<input type='checkbox' class='visibility-switch'>"), w = $("<input type='checkbox' class='visibility-switch'>"), T = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({width: "100%"}), _ = $("<tr>").appendTo(T), m = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({width: "50%"}).appendTo(_)), f = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({width: "50%"}).appendTo(_)), L = this.addLabeledRow(m, $.t("Left Labels"), C),
    ...
    inherit(i, n), i.prototype.prepareLayout = function () {
      ...
      this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), e = $("<tbody>").appendTo(this._table), t = d(), o = s(), i = this.createColorPicker(), n = this.addLabeledRow(e, "Line"), $("<td>").append(i).appendTo(n), $("<td>").append(t).appendTo(n), $('<td colspan="3">').append(o.render()).appendTo(n), this.bindControl(new l(i, this._linetool.properties().linecolor, !0, this.model(), "Change Fib Spiral Line Color")),
        this.bindControl(new r(o, this._linetool.properties().linestyle, parseInt, !0, this.model(), "Change Fib Spiral Line Style")), this.bindControl(new p(t, this._linetool.properties().linewidth, !0, this.model(), "Change Fib Spiral Line Width")), this.loadData()
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 777: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.FloatBinder, l = a.BooleanBinder, p = a.ColorBinding, s = a.SimpleComboBinder,
      d = a.SliderBinder, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, u, C, y, g, w, T, _, m = $("<tr>");
      ...
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), e = 1; e <= 11; e++)t = "level" + e, this.addLevelEditor("Level " + e, this._linetool.properties()[t], !1);
      this.addOneColorPropertyWidget(this._table), o = $("<input type='checkbox' class='visibility-switch'>"), i = this.addLabeledRow(this._table, $.t("Show Labels"), o), $("<td>").append(o).prependTo(i), n = $("<table cellspacing='0' cellpadding='0'>"), a = $("<select><option value='left'>" + $.t("left") + "</option><option value='center'>" + $.t("center") + "</option><option value='right'>" + $.t("right") + "</option></select>"), r = $("<select><option value='top'>" + $.t("top") + "</option><option value='middle'>" + $.t("middle") + "</option><option value='bottom'>" + $.t("bottom") + "</option></select>"), i = $("<tr>"), i.append("<td>" + $.t("Labels") + "</td>").append(a).append("<td>&nbsp</td>").append(r), i.appendTo(n), i = $("<tr>"), $("<td colspan='5'>").append(n).appendTo(i), i.appendTo(this._table), this.bindControl(new s(a, this._linetool.properties().horzLabelsAlign, null, !0, this.model(), "Change Fib Time Zone Labels Alignment")), this.bindControl(new s(r, this._linetool.properties().vertLabelsAlign, null, !0, this.model(), "Change Fib Time Zone Labels Alignment")), i = $("<tr>"), i.appendTo(this._table), p = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(p).appendTo(i),
    ...
    var n = o(14), a = o(10), r = a.FloatBinder, l = a.BooleanBinder, p = a.SliderBinder, s = a.SimpleComboBinder,
      d = a.ColorBinding, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, u, C, y, g, w, T, _, m = $("<tr>");
      m.appendTo(this._table), i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), e ? (a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : this.createLabeledCell($.t("Trend Line"), n).appendTo(m), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), w = b(), w.appendTo(g), T = $("<td>"), T.appendTo(m), _ = c(), _.render().appendTo(T), this.bindControl(new l(n, t.visible, !0, this.model(), "Change Pitchfork Line Visibility")), this.bindControl(new d(y, t.color, !0, this.model(), "Change Pitchfork Line Color", 0)), this.bindControl(new s(_, t.linestyle, parseInt, !0, this.model(), "Change Pitchfork Line Style")), this.bindControl(new p(w, t.linewidth, parseInt, this.model(), "Change Pitchfork Line Width"))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r, d, h, c, b;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().trendline, !1), e = 1; e <= 11; e++)t = "level" + e, this.addLevelEditor($.t("Level {0}").format(e), this._linetool.properties()[t], !1);
      this.addOneColorPropertyWidget(this._table), o = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({width: "100%"}), i = $("<tr>").appendTo(o), $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({width: "50%"}).appendTo(i)), $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({width: "50%"}).appendTo(i)), n = $("<input type='checkbox' class='visibility-switch'>"), a = this.addLabeledRow(this._table, $.t("Show Labels"), n), $("<td>").append(n).prependTo(a), r = $("<table cellspacing='0' cellpadding='0'>"),
    ...
    var n = o(14), a = o(10), r = a.FloatBinder, l = a.BooleanBinder, p = a.ColorBinding, s = a.SliderBinder,
      d = o(47).addColorPicker, h = o(15).createLineWidthEditor, c = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, c, b, u, C, y, g = $("<tr>");
      g.appendTo(this._table), i = $("<td>"), i.appendTo(g), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), e ? (a = $("<td>"), a.appendTo(g), c = $("<input type='text'>"), c.appendTo(a), c.css("width", "70px"), this.bindControl(new r(c, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : this.createLabeledCell("Trend Line", n).appendTo(g), b = $("<td class='colorpicker-cell'>"), b.appendTo(g), u = d(b), C = $("<td>"), C.appendTo(g), y = h(), y.appendTo(C), this.bindControl(new l(n, t.visible, !0, this.model(), "Change Fib Wedge Visibility")), this.bindControl(new p(u, t.color, !0, this.model(), "Change Fib Wedge Line Color", 0)), this.bindControl(new s(y, t.linewidth, !0, this.model(), "Change Fib Wedge Width"))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().trendline, !1), e = 1; e <= 11; e++)t = "level" + e, this.addLevelEditor("Level " + e, this._linetool.properties()[t], !1);
      this.addOneColorPropertyWidget(this._table), o = $("<input type='checkbox' class='visibility-switch'>"), i = this.addLabeledRow(this._table, "Levels", o),
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.SliderBinder, p = a.ColorBinding, s = o(47).addColorPicker,
      d = o(15).createLineWidthEditor, h = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addOneColorPropertyWidget = function (e) {
      var t = this.createOneColorForAllLinesWidget(), o = $("<tr>");
      o.append($("<td>")).append($("<td>")).append(t.editor).append($("<td>").append(t.label)), o.appendTo(e)
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, c, b, u, C, y, g, w, T, _, m, f, L, v, k, S, P, x, B, E, R, F;
      ...
      for (n in t.levels._childs)a = t.levels[n], c = $("<tr>"), c.appendTo(o), $("<td>" + n + "</td>").appendTo(c), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(c), u = $("<td class='colorpicker-cell'>"), u.appendTo(c), C = s(u),
        y = $("<td>"), y.appendTo(c), g = d(), g.appendTo(y), this.bindControl(new r(b, a.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, a.color, !0, this.model(), "Change Gann Line Color", 0)), this.bindControl(new l(g, a.width, !0, this.model(), "Change Gann Line Width"));
      w = $("<table>"), $("<td valign='top'>").append(w).appendTo(e), T = $("<tr>"), $("<td colspan='4'>" + $.t("Fans") + "</td>").appendTo(T), T.appendTo(w);
      for (n in t.fanlines._childs)_ = t.fanlines[n], m = $("<tr>"), m.appendTo(w), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(m), f = _.x.value() + "x" + _.y.value(), $("<td>" + f + "</td>").appendTo(m), u = $("<td class='colorpicker-cell'>"), u.appendTo(m), C = s(u), y = $("<td>"), y.appendTo(m), g = d(), g.appendTo(y), this.bindControl(new r(b, _.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, _.color, !0, this.model(), "Change Gann Fan Color", 0)), this.bindControl(new l(g, _.width, !0, this.model(), "Change Gann Line Width"));
      L = $("<table>"), $("<td valign='top'>").append(L).appendTo(e), v = $("<tr>"), $("<td colspan='4'>" + $.t("Arcs") + "</td>").appendTo(v), v.appendTo(L);
      for (n in t.arcs._childs)k = t.arcs[n], S = $("<tr>"), S.appendTo(L), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(S), f = k.x.value() + "x" + k.y.value(), $("<td>" + f + "</td>").appendTo(S), u = $("<td class='colorpicker-cell'>"), u.appendTo(S), C = s(u), y = $("<td>"), y.appendTo(S), g = d(), g.appendTo(y), this.bindControl(new r(b, k.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, k.color, !0, this.model(), "Change Gann Arc Color", 0)), this.bindControl(new l(g, k.width, !0, this.model(), "Change Gann Line Width"));
      this.addOneColorPropertyWidget(L), P = $("<tbody>").appendTo(this._table), x = $('<input type="checkbox" class="visibility-switch">'), B = h(), E = $("<tr>").appendTo(P), R = $("<table>"), $('<td colspan="3">').append(R).appendTo(E), E = $("<tr>").appendTo(R), $("<td>").append(x).appendTo(E), $("<td>" + $.t("Background") + "</td>").appendTo(E), $("<td>").append(B).appendTo(E), this._linetool.properties().reverse && (F = $("<input type='checkbox' class='visibility-switch'>"), E = this.addLabeledRow(R, $.t("Reverse"), F, !0), $("<td>").append(F).prependTo(E), this.bindControl(new r(F, this._linetool.properties().reverse, !0, this.model(), "Change Gann Square Reverse"))), this.bindControl(new r(x, this._linetool.properties().arcsBackground.fillBackground, !0, this.model(), "Change Gann Square Filling")), this.bindControl(new l(B, this._linetool.properties().arcsBackground.transparency, !0, this.model(), "Change Gann Square Background Transparency"))
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 783: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.ColorBinding, p = a.SimpleComboBinder, s = a.SliderBinder,
      d = o(47).addColorPicker, h = o(31).createLineStyleEditor, c = o(15).createLineWidthEditor,
      b = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o, i) {
      var n, a, b, u, C, y, g, w, T, _, m = $("<tr>");
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.FloatBinder, p = a.ColorBinding, s = a.SliderBinder,
      d = o(47).addColorPicker, h = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, s, h, c, b = $("<tr>");
      ...
      var t, o, i = $("<tr>").appendTo(e), n = $("<input type='checkbox' class='visibility-switch'>");
      n.appendTo($("<td>").appendTo(i)), $("<td>" + $.t("Angles") + "</td>").appendTo(i),
        t = $("<td class='colorpicker-cell'>").appendTo(i), o = d(t), this.bindControl(new r(n, this._linetool.properties().fans.visible, !0, this.model(), "Change Gann Square Angles Visibility")), this.bindControl(new p(o, this._linetool.properties().fans.color, !0, this.model(), "Change Gann Square Angles Color", 0))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, l, p, d, c, b, u, C, y, g, w, T, _, m, f;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page property-page-unpadded"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this._table.css({width: "100%"}), e = $("<tbody>").appendTo(this._table), t = $("<tr>"), t.appendTo(e), o = $('<td width="50%">'), o.appendTo(t), i = $('<td width="50%">'), i.appendTo(t), n = $('<table cellspacing="0" cellpadding="2">'), n.appendTo(o), n.addClass("property-page"), a = $('<table cellspacing="0" cellpadding="2">'), a.appendTo(i), a.addClass("property-page"), $("<tr><td align='center' colspan='4'>" + $.t("Price Levels") + "</td></tr>").appendTo(n), $("<tr><td align='center' colspan='4'>" + $.t("Time Levels") + "</td></tr>").appendTo(a), l = 1; l <= 7; l++)p = "hlevel" + l, this.addLevelEditor(n, $.t("Level {0}").format(l), this._linetool.properties()[p]);
      for (l = 1; l <= 7; l++)p = "vlevel" + l, this.addLevelEditor(a, $.t("Level {0}").format(l), this._linetool.properties()[p]);
      this.addFannEditor(n), this.addOneColorPropertyWidget(a), i.css({"vertical-align": "top"}), o.css({"vertical-align": "top"}), d = $("<input type='checkbox' class='visibility-switch'>"), c = $("<input type='checkbox' class='visibility-switch'>"), b = $("<input type='checkbox' class='visibility-switch'>"), u = $("<input type='checkbox' class='visibility-switch'>"), C = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({width: "100%"}), y = $("<tr>").appendTo(C), g = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({
        width: "50%",
        "vertical-align": "top"
      }).appendTo(y)), w = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo($("<td>").css({
        width: "50%",
        "vertical-align": "top"
      }).appendTo(y)), T = this.addLabeledRow(g, $.t("Left Labels"), d), $("<td>").append(d).prependTo(T), T = this.addLabeledRow(w, $.t("Right Labels"), c), $("<td>").append(c).prependTo(T), T = this.addLabeledRow(g, $.t("Top Labels"), b), $("<td>").append(b).prependTo(T), T = this.addLabeledRow(w, $.t("Bottom Labels"), u), $("<td>").append(u).prependTo(T), this.bindControl(new r(d, this._linetool.properties().showLeftLabels, !0, this.model(), "Change Gann Square Left Labels Visibility")), this.bindControl(new r(c, this._linetool.properties().showRightLabels, !0, this.model(), "Change Gann Square Right Labels Visibility")), this.bindControl(new r(b, this._linetool.properties().showTopLabels, !0, this.model(), "Change Gann Square Top Labels Visibility")), this.bindControl(new r(u, this._linetool.properties().showBottomLabels, !0, this.model(), "Change Gann Square Bottom Labels Visibility")), this._table = this._table.add(C), T = $("<tr>"), T.appendTo(g), _ = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(_).appendTo(T), m = h(),
    ...
    var n = o(14), a = o(10).ColorBinding;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i;
    ...
    var n = o(1).Point, a = o(14), r = o(10), l = r.ColorBinding, p = r.SimpleComboBinder, s = r.SimpleStringBinder,
      d = r.BooleanBinder, h = o(97);
    inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t, o, i, n = this.createColorPicker(), a = this.createFontSizeEditor(), r = this.createFontEditor(),
        h = this.createTextEditor(350, 200), c = this.createColorPicker(), b = this.createColorPicker(),
      ...
      if (e && t) {
        for (o = 0, i = this._linetool._model.paneForSource(this._linetool), a = h.getChartWidget(); o < a.paneWidgets().length; o++)if (a.paneWidgets()[o]._state === i) {
          r = $(a.paneWidgets()[o].canvas).offset().left;
          break
        }
        return l = (this._linetool.paneViews() || [])[0], p = new n(0, 0), l && (p = l._floatPoints[0] || this._linetool._fixedPoints[0] || p), s = (r || 0) + p.x, d = this._linetool.getTooltipWidth(), c = s - d / 2, b = t.outerWidth(), e.left < c && e.left + b + 10 > c ? (e.left -= e.left + b + 10 - c, e) : e.left > c && e.left < c + d + 10 ? (e.left += c + d + 10 - e.left, e) : void 0
      }
    }, e.exports = i
  }, 787: function (e, t, o) {
    "use strict";
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.FloatBinder, p = a.ColorBinding, s = a.SimpleComboBinder,
      d = a.SliderBinder, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, u, C, y, g, w, T, _, m = $("<tr>");
      m.appendTo(this._table), e ? (i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(n, t.visible, !0, this.model(), "Change Pitchfork Line Visibility")), this.bindControl(new l(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : $("<td colspan='2'>" + $.t("Median") + "</td>").appendTo(m), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), w = b(), w.appendTo(g), T = $("<td>"), T.appendTo(m), _ = c(), _.render().appendTo(T), this.bindControl(new p(y, t.color, !0, this.model(), "Change Pitchfork Line Color"), 0), this.bindControl(new s(_, t.linestyle, parseInt, !0, this.model(), "Change Pitchfan Line Style")), this.bindControl(new d(w, t.linewidth, !0, this.model(), "Change Pitchfan Line Width"))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"),
             this.addLevelEditor(null, this._linetool.properties().median, !1), e = 0; e <= 8; e++)t = "level" + e, this.addLevelEditor($.t("Level {0}").format(e + 1), this._linetool.properties()[t], !1);
      this.addOneColorPropertyWidget(this._table), o = $("<tr>"), o.appendTo(this._table), i = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(i).appendTo(o), this.createLabeledCell($.t("Background"), i).appendTo(o), n = u(), $('<td colspan="3">').append(n).appendTo(o), this.bindControl(new r(i, this._linetool.properties().fillBackground, !0, this.model(), "Change Pitchfan Background Visibility")), this.bindControl(new d(n, this._linetool.properties().transparency, !0, this.model(), "Change Pitchfan Background Transparency")), this.loadData()
    }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 789: function (e, t, o) {
    ...
    var n = o(14), a = o(10), r = a.BooleanBinder, l = a.FloatBinder, p = a.ColorBinding, s = a.SimpleComboBinder,
      d = a.SliderBinder, h = o(47).addColorPicker, c = o(31).createLineStyleEditor, b = o(15).createLineWidthEditor,
      u = o(65).createTransparencyEditor;
    inherit(i, n), i.prototype.onResoreDefaults = function () {
      this._linetool.properties().style.listeners().fire(this._linetool.properties().style)
    }, i.prototype.addLevelEditor = function (e, t, o) {
      var i, n, a, u, C, y, g, w, T, _, m = $("<tr>");
      m.appendTo(this._table), e ? (i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(n, t.visible, !0, this.model(), "Change Pitchfork Line Visibility")), this.bindControl(new l(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : ($("<td></td>").appendTo(m), $("<td>" + $.t("Median") + "</td>").appendTo(m)), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), w = b(), w.appendTo(g), T = $("<td>"), T.appendTo(m), _ = c(), _.render().appendTo(T), this.bindControl(new p(y, t.color, !0, this.model(), "Change Pitchfork Line Color", 0)), this.bindControl(new s(_, t.linestyle, parseInt, !0, this.model(), "Change Pitchfork Line Style")), this.bindControl(new d(w, t.linewidth, !0, this.model(), "Change Pitchfork Line Width"))
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a;
      for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().median, !1), e = 0; e <= 8; e++)t = "level" + e, this.addLevelEditor($.t("Level {0}").format(e + 1), this._linetool.properties()[t], !1);
    ...
    var n = o(14), a = o(10), r = a.ColorBinding, l = a.SliderBinder, p = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, s, d, h, c, b, u, C, y, g, w, T, _,
        m = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
        f = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({width: "100%"}),
        L = $('<table class="property-page" cellspacing="0" cellpadding="2">');
      this._table = m.add(f).add(L), e = this.createColorPicker(), t = p(), o = this.addLabeledRow(m, "Line"), $("<td>").append(e).appendTo(o), $("<td>").append(t).appendTo(o), i = $("<tr>").appendTo(f), n = $("<td>").appendTo(i).css({
        "vertical-align": "top",
        width: "50%"
      }), a = $("<td>").appendTo(i).css({
        "vertical-align": "top",
        width: "50%"
      }), s = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(n), d = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(a), h = this.addColorPickerRow(s, $.t("Source back color")), c = this.addColorPickerRow(s, $.t("Source text color")), b = this.addColorPickerRow(s, $.t("Source border color")),
    ...
    var n = o(14), a = o(10), r = a.SliderBinder, l = a.ColorBinding, p = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
    ...
    var n = o(14), a = o(10), r = a.ColorBinding, l = a.BooleanBinder, p = a.SliderBinder,
      s = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;
    ...
    i.prototype.attachSource = function (e, t) {
      ...
      var o, i, n, a, r, l, p, s = 5, d = 0, h = this._linetool, c = h._model.paneForSource(h),
        b = this._model._chartWidget;
      return $.each(b.paneWidgets(), function (e, t) {
        if (t._state === c)return d = $(t.canvas).offset().top, !1
      }), e || (e = {}), i = e.left, n = e.top, a = (this._linetool.paneViews() || [])[0], a && (o = a._floatPoints[0]), o && (i = o.x, n = o.y + d), r = $(t).outerHeight(), l = $(window).height(), p = h.properties().fontsize.value(), n = n + r + p + s <= l ? n + p + s : n - r - s, {
        top: n,
        left: i
      }
    }, e.exports = n
    ...
    var n = o(14), a = o(10), r = a.SimpleComboBinder, l = a.ColorBinding, p = a.SliderBinder, s = a.BooleanBinder,
      d = o(31).createLineStyleEditor, h = o(15).createLineWidthEditor;
    inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, c, b;
    ...
    var n = o(10).PropertyPage, a = o(271).StudyInputsPropertyPage, r = o(81), l = o(45), p = o(121);
    inherit(i, r),
      i.prototype.prepareLayout = function () {
        var e, t, o, i, n, r, s, d, h = $('<table class="property-page" cellspacing="0" cellpadding="0">'),
        ...
        for (this._table = h.add(c), e = this._linetool.points(), t = 0; t < e.length; t++)o = $("<tr>"), o.appendTo(h), i = $("<td>"), i.html("Point " + (t + 1) + " Bar #"), i.appendTo(o), n = $("<td>"), n.appendTo(o), r = $("<input type='text'>"), r.appendTo(n), r.addClass("ticker"), s = this._linetool.properties().points[t], this.bindBarIndex(s.bar, r, this.model(), "Change " + this._linetool + " point bar index");
        d = l.findStudyMetaInfo(this._model.studiesMetaData(), this._linetool.studyId()), a.prototype.prepareLayoutImpl.call(this, d, c)
      }, i.prototype.widget = function () {
      return this._table
    }, e.exports = i
  }, 813: function (e, t, o) {
    ...
    var n = o(407), a = o(10), r = a.PropertyPage, l = a.BooleanBinder, p = a.SimpleComboBinder,
      s = o(208).StudyStylesPropertyPage, d = o(71);
    inherit(i, r), inherit(i, n), i.prototype._isJapaneseChartsAvailable = function () {
      return !1
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
        ...
        h = $('<table class="property-page" cellspacing="0" cellpadding="2">'), c = this._study.properties();
      this._prepareSeriesStyleLayout(n, a, r, c), this._table = n.add(a).add(r).add(d).add(h), e = $('<input type="checkbox">'), t = this.addLabeledRow(d, "Price Line", e), $("<td>").append(e).prependTo(t), this.bindControl(new l(e, c.showPriceLine, !0, this.model(), "Change Price Price Line")), o = this.createSeriesMinTickEditor(), i = $("<tr>"), i.appendTo(h), $("<td>" + $.t("Override Min Tick") + "</td>").appendTo(i), $("<td>").append(o).appendTo(i), this.bindControl(new p(o, c.minTick, null, !0, this.model(), "Change MinTick")), s.prototype._putStudyDefaultStyles.call(this, h)
    }, i.prototype.loadData = function () {
      this.superclass.prototype.loadData.call(this), this.switchStyle()
    }, i.prototype.switchStyle = function () {
      switch ($(this._barsTbody).add(this._barsColorerTbody).add(this._candlesTbody).add(this._candlesColorerTbody).add(this._hollowCandlesTbody).add(this._lineTbody).add(this._areaTbody).add(this._baselineTbody).css("display", "none"), this._study.properties().style.value()) {
        case d.STYLE_BARS:
          this._barsTbody.css("display", "table-row-group"), this._barsColorerTbody.css("display", "table-row-group");
          break;
    ...
    var n = o(21).assert, a = o(10), r = a.PropertyPage, l = a.GreateTransformer, p = a.LessTransformer,
      s = a.ToIntTransformer, d = a.ToFloatTransformer, h = a.BooleanBinder, c = a.SimpleComboBinder,
      b = a.SimpleStringBinder, u = o(38).NumericFormatter;
    inherit(i, r), i.prototype._getStrategyInputs = function () {
      for (var e, t = 0, o = this._study.metaInfo(), i = {}; t < o.inputs.length; t++)e = o.inputs[t], "strategy_props" === e.groupId && (n(void 0 !== e.internalID, "Strategy input id=" + e.id + " doesn't have an internalID"), i[e.internalID] = o.inputs[t]);
      return TradingView.clone(i)
    }, i.prototype._setStdInput = function (e, t, o) {
      var i, n, a, r, C, y, g, w, T, _, m, f;
      if (e) {
        if (i = e.id, n = "study_input-" + i + "-" + Date.now().toString(36) + "-" + Math.random().toString(36), a = $("<tr>").appendTo(this._$table), r = "Change " + t, C = $('<label for="' + n + '">' + $.t(t, {context: "input"}) + "</label>"), "bool" === e.type) g = $('<td colspan="3">').appendTo(a), y = $('<input id="' + n + '" type="checkbox">').appendTo(g), C.appendTo(g), !0 !== o && this.bindControl(new h(y, this._property.inputs[i], !0, this.model(), r)); else if ($("<td>").addClass("propertypage-name-label").append(C).appendTo(a), w = $('<td colspan="2">').appendTo(a), e.options) {
          for (y = $('<select id="' + n + '">').appendTo(w), T = 0; T < e.options.length; T++)_ = e.options[T], _ instanceof jQuery ? _.appendTo(y) : $('<option value="' + _ + '">' + _ + "</option>").appendTo(y);
          !0 !== o && this.bindControl(new c(y, this._property.inputs[i], null, !0, this.model(), r))
        } else y = $('<input id="' + n + '" type="text">').appendTo(w), !0 !== o && ("integer" !== e.type && "float" !== e.type || (m = ["integer" === e.type ? s(e.defval) : d(e.defval)], (0 === e.min || e.min) && m.push(l(e.min)), (0 === e.max || e.max) && m.push(p(e.max))), f = new b(y, this._property.inputs[i], m, !1, this.model(), r), "float" === e.type && f.addFormatter(function (e) {
          return (new u).format(e)
        }), this.bindControl(f)), y.addClass("ticker");
        return y
      }
    }, i.prototype._setPyramidingInputs = function (e) {
      var t = e.pyramiding, o = this._property.inputs[t.id],
        i = this._setStdInput({id: "pyramiding_switch", type: "bool"}, $.t("Pyramiding"), !0),
        a = this._setStdInput(e.pyramiding, $.t("Allow up to")), r = a.closest("tr");
      n(void 0 === this._onAllowUpToChanged), this._onAllowUpToChanged = function (e) {
        e.value() > 0 ? (i.prop("checked", !0), a.removeAttr("disabled"), r.removeClass("disabled")) : (i.prop("checked", !1), a.attr("disabled", "disabled"), r.addClass("disabled"))
      }, o.subscribe(null, this._onAllowUpToChanged), i.change(function () {
        var e = !i.prop("checked");
        o.setValue(e ? 0 : t.defval), e ? a.attr("disabled", "disabled") : a.removeAttr("disabled"), r.toggleClass("disabled", e)
      }), o.value() > 0 ? i.prop("checked", !0) : (i.prop("checked", !1), a.attr("disabled", "disabled"), r.addClass("disabled")), r.children().last().removeAttr("colspan"), $("<td>").text($.t("orders", {context: "up to ... orders"})).appendTo(r)
    }, i.prototype._setQtyInputs = function (e) {
      function t(e) {
        return e = +e, isNaN(e) || e < 0 ? 0 : ("percent_of_equity" !== a.val() ? e = parseInt(e) : e > 100 && (e = 100), e)
      }

      var o, i, n, a, r, l, p = this, s = e.default_qty_value, d = $.extend({}, e.default_qty_type),
        h = this._property.inputs[s.id], c = this._setStdInput(s, $.t("Order size"), !0),
        u = new b(c, h, t, !1, this.model(), "Change Order Size");
      this.bindControl(u), o = c.closest("td"), o.removeAttr("colspan"), i = this._study.reportData() && this._study.reportData().currency || "USD", n = $('<option value="cash_per_order">' + i + "</option>"), d.options = [$('<option value="fixed">' + $.t("Contracts") + "</option>"), n, $('<option value="percent_of_equity">' + $.t("% of equity") + "</option>")], a = this._setStdInput(d, "type"), r = a.closest("td"), l = r.closest("tr"), r.removeAttr("colspan"), r.detach().insertAfter(o), l.remove(), this._study.watchedData.subscribe(function () {
        p.__updateComboCurrency(n, a, "cash_per_order")
      })
    }, i.prototype.__updateComboCurrency = function (e, t, o, i) {
      var n, a = this._study.reportData() && this._study.reportData().currency || "USD";
      i && (a += i), e.text(a), n = t.closest("td"), n.find("a[href=#" + o + "]").text(a), e.prop("selected") && n.find(".sbSelector").text(a)
      ...
      var t = this._setStdInput(e.backtest_fill_limits_assumption, $.t("Verify Price for Limit Orders")),
        o = t.closest("td");
      o.removeAttr("colSpan"), $("<td>").text($.t("ticks", {context: "slippage ... ticks"})).insertAfter(o)
    }, i.prototype._setSlippageInputs = function (e) {
      var t, o;
      void 0 !== e.slippage && (t = this._setStdInput(e.slippage, $.t("Slippage")), o = t.closest("td"), o.removeAttr("colSpan"), $("<td>").text($.t("ticks", {context: "slippage ... ticks"})).insertAfter(o))
    }, i.prototype._setCommissionInputs = function (e) {
      function t(e) {
        return e = +e, isNaN(e) || e < 0 ? 0 : ("percent" !== c.val() ? e = parseFloat(e) : e > 100 && (e = 100), e)
      }

      var o, i, n, a, r, l, p, s, d, h, c, u, C;
      void 0 !== e.commission_value && void 0 !== e.commission_type && (o = this, i = e.commission_value, n = $.extend({}, e.commission_type), a = this._property.inputs[i.id], r = this._setStdInput(i, $.t("Commission"), !0), l = new b(r, a, t, !1, this.model(), "Change Commission value"), this.bindControl(l), p = r.closest("td"), p.removeAttr("colspan"), s = this._study.reportData() && this._study.reportData().currency || "USD", d = $('<option value="cash_per_order">' + s + $.t(" per order") + "</option>"), h = $('<option value="cash_per_contract">' + s + $.t(" per contract") + "</option>"), n.options = [$('<option value="percent">' + $.t("%") + "</option>"), d, h], c = this._setStdInput(n, "type"), u = c.closest("td"), C = u.closest("tr"), u.removeAttr("colspan"), u.detach().insertAfter(p), C.remove(), this._study.watchedData.subscribe(function () {
        o.__updateComboCurrency(d, c, "cash_per_order", $.t(" per order")), o.__updateComboCurrency(h, c, "cash_per_contract", $.t(" per contract"))
      }))
    }, i.prototype.prepareLayout = function () {
      this._$table = $(document.createElement("table")).addClass("property-page strategy-properties").attr("cellspacing", "0").attr("cellpadding", "2");
      var e = this._getStrategyInputs();
      e.initial_capital.min = 1, this._setStdInput(e.initial_capital, $.t("Initial capital")), Array.isArray(e.currency.options) && "NONE" === e.currency.options[0] && (e.currency.options[0] = $('<option value="NONE">' + $.t("Default") + "</option>")), this._setStdInput(e.currency, $.t("Base currency")),
      ...
      var e, t, o;
      r.prototype.loadData.call(this), e = this._getStrategyInputs(), t = e.pyramiding, o = this._property.inputs[t.id], o.setValue(o.value(), !0)
    }, i.prototype.destroy = function () {
      var e, t, o;
      r.prototype.destroy.call(this), e = this._getStrategyInputs(), t = e.pyramiding, o = this._property.inputs[t.id], o.unsubscribe(null, this._onAllowUpToChanged)
    }, e.exports = i
  }, 820: function (e, t, o) {
    "use strict";
    function i(e, t, o) {
    ...
    function i() {
      var e = $("<select />");
      return $('<option value="' + n.HHISTDIR_LEFTTORIGHT + '">' + $.t("Left") + "</option>").appendTo(e), $('<option value="' + n.HHISTDIR_RIGHTTOLEFT + '">' + $.t("Right") + "</option>").appendTo(e), e
    }
    ...
    function i() {
      var e = $("<select>");
      return $('<option value="open">' + $.t("Open") + "</option>").appendTo(e), $('<option value="high">' + $.t("High") + "</option>").appendTo(e), $('<option value="low">' + $.t("Low") + "</option>").appendTo(e), $('<option value="close">' + $.t("Close") + "</option>").appendTo(e), $('<option value="hl2">' + $.t("(H + L)/2") + "</option>").appendTo(e), $('<option value="hlc3">' + $.t("(H + L + C)/3") + "</option>").appendTo(e), $('<option value="ohlc4">' + $.t("(O + H + L + C)/4") + "</option>").appendTo(e), e
    }

    Object.defineProperty(t, "__esModule", {value: !0}), o(22), o(23), t.createPriceSourceEditor = i
  }, 1122: function (e, t, o) {
    "use strict";
    function i() {
      return $('<select><option value="' + n.MARKLOC_ABOVEBAR + '">' + $.t("Above Bar") + '</option><option value="' + n.MARKLOC_BELOWBAR + '">' + $.t("Below Bar") + '</option><option value="' + n.MARKLOC_TOP + '">' + $.t("Top") + '</option><option value="' + n.MARKLOC_BOTTOM + '">' + $.t("Bottom") + '</option><option value="' + n.MARKLOC_ABSOLUTE + '">' + $.t("Absolute") + "</option></select>")
    }
    ...
    function i() {
      var e = "<select>";
      return Object.keys(n.plotShapesData).forEach(function (t) {
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), o(22), t.createVisibilityEditor = i
  }
});
